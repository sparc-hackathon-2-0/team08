...
public class Video5 extends Activity implements SurfaceHolder.Callback, OnCompletionListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mMedia = new MediaController(this, true);
		 ...
		 mVideoView.setVideoURI(Uri.parse("android.resource://" + getPackageName() +"/"+R.raw.video5)); 
